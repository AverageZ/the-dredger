...
func (o *OllamaClient) Summarize(ctx context.Context, title, description, url string, comments []string) (string, []string, error) {
	reqBody := ollamaRequest{
		Model:  o.model,
		Prompt: buildSummaryPrompt(title, description, url, comments),
		Stream: false,
	}
